...
var settings = {
    authority: 'https://auth.zorg.ca', // Gluu
    //authority: 'http://localhost:3000', // node-oidc-provider
    //authority: 'http://localhost:5000', // Identity Server
    //authority: 'http://localhost:8080/auth/realms/master', //keycloak
    client_id: '@!3BC5.7DE4.A773.CEDD!0001!F6EF.ABA6!0008!CE06.B232.F3C2.8142',
    redirect_uri: 'http://localhost:16000/user-manager-sample.html',
    post_logout_redirect_uri: 'http://localhost:16000/user-manager-sample.html',
    response_type: 'id_token token',
    scope: 'openid profile email user_name',
    // acr_values: 'basic_lock',
    // prompt: 'true',
    
    popup_redirect_uri:'http://localhost:16000/user-manager-sample-popup-signin.html',
    popup_post_logout_redirect_uri:'http://localhost:16000/user-manager-sample-popup-signout.html',
    
    silent_redirect_uri:'http://localhost:16000/user-manager-sample-silent.html',
...
mgr.events.addUserSessionChanged(function (e) {
    console.log("user session changed1!!", e);
});

mgr.events.addUserSignedOut(function (e) {
    console.log("user signed out!", e);
    removeUser();
    clearState();
